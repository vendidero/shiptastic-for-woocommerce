 ...
 */
class Units extends \Vendidero\Shiptastic\Tests\Framework\UnitTestCase {

	function test_packaging_without_units() {
		update_option( 'woocommerce_dimension_unit', 'cm' );
		update_option( 'woocommerce_weight_unit', 'kg' );

		$new_packaging = new \Vendidero\Shiptastic\Packaging();
		...
		$box = new \Vendidero\Shiptastic\Packing\PackagingBox( $new_packaging );
