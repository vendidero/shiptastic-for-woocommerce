<?php
/**
 * Customer return shipment rejected
 *
 * This template can be overridden by copying it to yourtheme/shiptastic/emails/customer-return-shipment-rejected.php.
 *
...
<p>
	<?php echo esc_html_x( 'We are sorry to let you know that your return request has been rejected.', 'shipments', 'shiptastic-for-woocommerce' ); ?>
</p>
