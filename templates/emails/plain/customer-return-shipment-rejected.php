<?php
/**
 * Customer return shipment rejected (plain text)
 *
 * This template can be overridden by copying it to yourtheme/shiptastic/emails/plain/customer-return-shipment-rejected.php.
 *
...
echo esc_html_x( 'We are sorry to let you know that your return request has been rejected.', 'shipments', 'shiptastic-for-woocommerce' );
