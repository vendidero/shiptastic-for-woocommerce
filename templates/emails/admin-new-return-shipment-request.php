...
<?php /* translators: %s: Customer billing full name */ ?>
	<p><?php printf( esc_html_x( 'You’ve received the following return request from %s:', 'shipments', 'shiptastic-for-woocommerce' ), esc_html( $shipment->get_formatted_sender_full_name() ) ); ?></p>
<?php
