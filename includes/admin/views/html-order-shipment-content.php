				...
				<div class="shipment-item-actions shipment-inner-actions">
					<?php
						$actions = array(
							'add_item'   => array(
								'action'            => 'add_item',
								'name'              => _x( 'Add item', 'shipments', 'shiptastic-for-woocommerce' ),
							...
							'sync_items' => array(
								'action'  => 'sync_items',
								'name'    => _x( 'Sync items', 'shipments', 'shiptastic-for-woocommerce' ),
								'title'   => _x( 'Automatically adjust items and quantities based on order item data.', 'shipments', 'shiptastic-for-woocommerce' ),
								...
								<div class="wc-backbone-modal-content">
									<section class="wc-backbone-modal-main" role="main">
										<header class="wc-backbone-modal-header">
											<h1><?php echo esc_html_x( 'Add Item', 'shipments', 'shiptastic-for-woocommerce' ); ?></h1>
			...
			<div class="shipment-footer-inner">
				<?php if ( 'return' === $shipment->get_type() && $shipment->has_status( 'processing' ) ) : ?>
					<a class="shipment-footer-action send-return-shipment-notification email" href="#" data-id="<?php echo esc_attr( $shipment->get_id() ); ?>">
						<?php echo wc_help_tip( _x( 'Send return instructions to your customer via email including return label as attachment (if available).', 'shipments', 'shiptastic-for-woocommerce' ) ); ?>
						<?php echo ( $shipment->is_customer_requested() ? esc_html_x( 'Resend notification', 'shipments', 'shiptastic-for-woocommerce' ) : esc_html_x( 'Notify customer', 'shipments', 'shiptastic-for-woocommerce' ) ); ?>
					</a>
