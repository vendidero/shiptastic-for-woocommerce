...
<table class="wc-stc-shipping-providers widefat">
	...
	<tr>
		<th class="sort"></th>
		<th class="wc-stc-shipping-provider-title"><?php echo esc_html_x( 'Title', 'shipments', 'shiptastic-for-woocommerce' ); ?></th>
		<th class="wc-stc-shipping-provider-desc"><?php echo esc_html_x( 'Description', 'shipments', 'shiptastic-for-woocommerce' ); ?></th>
		<th class="wc-stc-shipping-provider-activated"><?php echo esc_html_x( 'Activated', 'shipments', 'shiptastic-for-woocommerce' ); ?></th>
		...
		<tr data-shipping-provider="<?php echo esc_attr( $provider->get_name() ); ?>">
			<td class="sort" id="wc-stc-shipping-provider-sort-<?php echo esc_attr( $provider->get_name() ); ?>">
				<div class="wc-item-reorder-nav wc-stc-shipping-provider-reorder-nav">
					...
					<button type="button" class="wc-move-down" tabindex="0" aria-hidden="false" aria-label="<?php /* Translators: %s Payment gateway name. */ echo esc_attr( sprintf( _x( 'Move the "%s" provider down', 'shipments', 'shiptastic-for-woocommerce' ), esc_html( $provider->get_title() ) ) ); ?>"><?php echo esc_html_x( 'Move down', 'shipments', 'shiptastic-for-woocommerce' ); ?></button>
			...
			<td class="wc-stc-shipping-provider-activated" id="wc-stc-shipping-provider-activated-<?php echo esc_attr( $provider->get_name() ); ?>">
				...
				<?php else : ?>
					<fieldset>
						<a class="woocommerce-shiptastic-input-toggle-trigger" href="#"><span class="woocommerce-shiptastic-input-toggle woocommerce-input-toggle woocommerce-input-toggle--<?php echo( $provider->is_activated() ? 'enabled' : 'disabled' ); ?>"><?php echo esc_attr_x( 'Yes', 'shipments', 'shiptastic-for-woocommerce' ); ?></span></a>
						<input
			...
			<td class="wc-stc-shipping-provider-actions">
				<?php if ( '' !== $provider->get_help_link() ) : ?>
					<a
						...
						aria-label="<?php echo esc_attr_x( 'Help', 'shipments', 'shiptastic-for-woocommerce' ); ?>"
						title="<?php echo esc_attr_x( 'Help', 'shipments', 'shiptastic-for-woocommerce' ); ?>"
						href="<?php echo esc_url( $provider->get_help_link() ); ?>"
					><?php echo esc_html_x( 'Help', 'shipments', 'shiptastic-for-woocommerce' ); ?></a>
				<?php endif; ?>
				<?php if ( '' !== $provider->get_edit_link() ) : ?>
					<a
						class="button button-secondary wc-shiptastic-dash-button"
						aria-label="<?php echo esc_attr_x( 'Manage shipping provider', 'shipments', 'shiptastic-for-woocommerce' ); ?>"
						title="<?php echo esc_attr_x( 'Manage shipping provider', 'shipments', 'shiptastic-for-woocommerce' ); ?>"
						href="<?php echo esc_url( $provider->get_edit_link() ); ?>"
					><?php echo esc_html_x( 'Manage', 'shipments', 'shiptastic-for-woocommerce' ); ?>
					</a>
				<?php endif; ?>
			</td>
		</tr>
