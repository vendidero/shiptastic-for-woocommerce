...
if ( ! class_exists( 'WC_STC_Email_New_Return_Shipment_Request', false ) ) :
	...
	class WC_STC_Email_New_Return_Shipment_Request extends WC_Email {
		...
		public function __construct() {
			...
			$this->title       = _x( 'New order return request', 'shipments', 'shiptastic-for-woocommerce' );
			$this->description = _x( 'New order return request emails are sent to chosen recipient(s) when a new return is requested.', 'shipments', 'shiptastic-for-woocommerce' );
		...
		public function get_default_subject() {
			return _x( '[{site_title}]: New return request to #{order_number}', 'shipments', 'shiptastic-for-woocommerce' );
		}
		...
		public function init_form_fields() {
			...
			$this->form_fields = array_merge(
				...
				array(
					'recipient' => array(
						'title'       => _x( 'Recipient(s)', 'shipments', 'shiptastic-for-woocommerce' ),
						'type'        => 'text',
						/* translators: %s: WP admin email */
						'description' => sprintf( _x( 'Enter recipients (comma separated) for this email. Defaults to %s.', 'shipments', 'shiptastic-for-woocommerce' ), '<code>' . esc_attr( get_option( 'admin_email' ) ) . '</code>' ),
						'placeholder' => '',
						'default'     => '',
						'desc_tip'    => true,
					),
